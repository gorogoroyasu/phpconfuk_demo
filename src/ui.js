(function() {
    ...
    UI.prototype._setupTrainElement = function() {
        ...
        this._trainElement.appendChild(createSectionHeading('学習データ'));
    ...
    UI.prototype._setupTestElement = function() {
        ...
        this._testElement.appendChild(createSectionHeading('入力データ'));
    ...
    UI.prototype._cellChanged = function() {
        ...
        this._clearAllButton.textContent = '学習データ全部消す';
        this._clearButton.textContent = '入力データ消す';
    };
    ...
    window.onload = function() {
        new UI();
        $('.few-shot-container-clear-all').click();
        $('.few-shot-container-clear').click();
    };
